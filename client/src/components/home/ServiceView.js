...
import ServiceView3 from "../../assets/service-view-invite.jpg";
        ...
        <div className="view">
            ...
            <div className="view-card-container">
                ...
                <ViewData
                    image={ServiceView2}
                    heading="Tasks"
                    text="Set goals for a project by creating tasks and organizing them into lists. Creating tasks lets you keep track of what should get done and what has been finished."
                />
                <ViewData
                    image={ServiceView3}
